...
export default function AuthPlaceholder() {
  ...
  return (
    <div className="bg-white h-screen w-[50vw] md:flex items-center justify-center relative hidden">
      ...
      />
      <div className="relative min-w-[70%] min-h-[45%] px-5">
        ...
        <section className="shadow p-5 min-w-[55%] absolute right-0 rounded-[24px] self-end bg-white flex justify-between translate-y-[-15px]">
          <div>
            <img
